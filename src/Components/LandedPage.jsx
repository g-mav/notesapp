...
import './LandedPage.css';

const LandedPage = () => {
  return (
    <div className="landed-page">
      {/* Header */}
      <Navbar className="navbar-landed" expand="lg">
        <Container>
          ...
          <div className="ms-auto">
            <Link to="/login">
              <Button variant="primary" className="px-4">Your Notes</Button>
            </Link>
          </div>
        </Container>
      </Navbar>
      ...
      {/* Footer */}
      <footer className="footer-landed py-4">
        <Container>
